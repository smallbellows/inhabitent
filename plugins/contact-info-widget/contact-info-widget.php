 ...
 * @license   GPL-2.0+
 * @link
 * @copyright 2015 Sara Given
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Contact Info Widget
 * Plugin URI:        http://inhabitent.dev
 * Description:       A handy contact info widget for the Inhabitent Site
 * Version:           1.0.0
 * Author:            Sara Given
 * Author URI:        http://www.github.com/smallbellows
 * License:           GPL-2.0+
...
class Inhabitent_Contact_Info extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'inhabitent-contact';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Set conctact information for the store.'
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		$address1 = empty( $instance['address1'] ) ? '' : apply_filters( 'widget_address1', $instance['address1'] );
		$address2 = empty( $instance['address2'] ) ? '' : apply_filters( 'widget_address2', $instance['address2'] );
	...
	public function form( $instance ) {
		...
		$address2 = strip_tags( $instance['address2'] );
